  ...
  return (
    <div className="mx-10 mt-24 text-white">
      <div className="max-w-[1400px] ">
        ...
        <p className="mt-8">
          Welcome to iFake.email! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          iFake.email is a minimalistic temporary email service that allows you to
          ...
          iFake.email operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that iFake.email is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to iFake.email and its services
          belong to iFake.email. You may not copy, reproduce, distribute, modify,
          or create derivative works of iFake.email or any part thereof without
          explicit permission from iFake.email.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use iFake.email. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using iFake.email, you agree not to
        ...
        <p className="mt-4">
          iFake.email is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of iFake.email is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall iFake.email or
          ...
          from your access to or use of iFake.email or any content or services
          provided through iFake.email.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of iFake.email after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where iFake.email is located. Any disputes
